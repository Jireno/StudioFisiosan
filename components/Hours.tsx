        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-sky-100 mb-8 text-lg">
              Siamo aperti tutta la settimana per venire incontro alle tue esigenze.
              Il nostro staff è disponibile per appuntamenti urgenti previa disponibilità.
            </p>
                 ...
                 {HOURS.map((item, idx) => (
                   <div key={idx} className="flex justify-between items-center border-b border-sky-800 pb-3 last:border-0 last:pb-0">
                     ...
                     <span className="font-bold tracking-wide flex items-center gap-2">
                       {item.hours !== "Chiuso" && <Clock size={16} className="text-sky-400" />}
                       {item.hours}
                     </span>
                   </div>
                 ))}
